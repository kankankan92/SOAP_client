...
public abstract class NumberConversionCallbackHandler {
    ...
    public void receiveResultnumberToDollars(
        com.company.numberconversion.NumberConversionStub.NumberToDollarsResponse result) {
    }
    ...
    public void receiveResultnumberToWords(
        com.company.numberconversion.NumberConversionStub.NumberToWordsResponse result) {
    }
